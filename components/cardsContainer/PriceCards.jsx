...
const PriceCards = (props) => {
  ...
  return (
    <Stack bg={background} w='sm' h='lg' borderRadius={10} p={10} gap={5}>
      ...
      <Flex direction='column' alignItems='center' color={color} fontWeight='bold' >
        <Text py={5} w='xs' textAlign='center' borderTop='1px solid white' >{props.storage} Storage</Text>
        <Text py={5} w='xs' textAlign='center' borderTop='1px solid white' >{props.users} Users Allowed</Text>
        <Text w='xs' textAlign='center' borderTop='1px solid white' borderBottom='1px solid white' py='5' >Send up to {props.gb} GB</Text>
      </Flex>
